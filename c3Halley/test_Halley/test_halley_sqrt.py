...
def run_sqrt_with_print(S):
    return halley_sqrt(S, precision_dps=PRECISION, print_guesses=True)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            820367881278051.8,
            "Number of guesses: 37, Threshold: 1e-12, Estimate iterations: 1.\n",
        ),
        (
            1_000_000_000_000_000_000_000_000_000_000,
            1000000000000000.0,
            "Number of guesses: 34, Threshold: 1e-12, Estimate iterations: 1.\n",
        ),
        (
